      ...
      <div className="start-journey">
        ...
        <div className="journey-perks">
          <div className="anon">
            ...
            <p>
              Share your problems without revealing <br /> your identity. Your
              privacy is our top <br /> priority.
            </p>
          </div>
          <div className="global">
            ...
            <p>
              Connect with people from all walks of <br /> life who understand
              and empathize <br /> with your situation.
            </p>
          </div>
          <div className="guidance">
            ...
            <p>
              Receive advice, support, and <br /> encouragement from those who
              have <br /> experienced similar challenges.
            </p>
          </div>
        </div>
      </div>
